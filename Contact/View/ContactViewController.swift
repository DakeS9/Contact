...
class ContactViewController: UIViewController {
    ...
    @IBOutlet weak var inistialsLabel: UILabel!
    ...
    @IBOutlet weak var videoCallStackView: UIStackView!
    ...
    override func viewDidLoad() {
        ...
        videoCallStackView.layer.cornerRadius = 5
        messageStackView.layer.cornerRadius = 5
    ...
    func setupContactContent() {
        inistialsLabel.text = "\(contact.firstName.first!) \(contact.lastName.first!)"
    ...
    @IBAction func undoDeleteTapped(_ sender: Any) {
        timer?.invalidate()
    ...
    @IBAction func deleteButtonTapped(_ sender: UIButton) {
        let alertController = UIAlertController(title: "Warning!", message: "Are you sure want to delete this", preferredStyle: .alert)
